...
records (O1, O5). It selected and justified an open ASR model (Whisper via
...
The evaluation itself is a direction for growth: expanding the corpus with real,
user-corrected utterances; reporting \emph{per-dialect} WER and
F\textsubscript{1} (Gulf, Egyptian, Levantine) rather than a single Arabic figure;
and adding a longitudinal study of how often users must edit extractions in real
use---the truest measure of the friction reduction the project set out to achieve.
